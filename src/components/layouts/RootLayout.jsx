...
import NavbarWithNavigation from "@/components/layouts/header/navbar-with-navigation";
import DesktopNavigateContent from "@/components/layouts/header/navbar-with-navigation/DesktopNavigateContent";
