...
const ProductCard = ({ product, categorySlug = "category" }) => {
  ...
  return (
    <>
      {showPopup && (
        <div className="animate-in slide-in-from-top-2 fade-in fixed top-20 right-4 z-50 duration-300">
          <div className="flex min-w-62.5 items-center gap-3 rounded-lg bg-green-500 px-4 py-3 text-white shadow-lg">
            ...
            <div className="flex-1">
              ...
              <p className="max-w-45 truncate text-xs text-white/90">{title}</p>
            </div>
          </div>
        </div>
      )}
